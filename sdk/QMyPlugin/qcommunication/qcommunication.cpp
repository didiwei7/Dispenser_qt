...
void QMySocket::setupUi()
{
    ...
    layout_2_3->addLayout(layout_3_2);

    layout_3_1->addWidget(radio_client);
    layout_3_1->addWidget(radio_server);

    layout_3_2->addWidget(btn_send);
    layout_3_2->addWidget(btn_hex);
    layout_3_2->addWidget(btn_clear);
    layout_3_2->addSpacerItem(new QSpacerItem(0, 0, QSizePolicy::Maximum, QSizePolicy::Expanding));
    ...
    if(radio_client->isChecked())
    {
        ...
        else
        {
            ...
            else
            {
                ...
                client->write(hex_data, length);
            }
            if (btn_clear->isChecked()) text_send->clear();
        }
    }
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                m_socket->write(hex_data, length);
            }
            if (btn_clear->isChecked()) text_send->clear();
        }
