...
int CONTROLSHARED_EXPORT OpenCard_leaser(int mnums,int ionums)
{
    int rtn;
    if (0 != mnums)
    {
...
int CONTROLSHARED_EXPORT LoadConfigFile(int cardindex ,char* path)
{
...
int CONTROLSHARED_EXPORT CloseIO_leaser(int mnums,int ionums)
{
...
int CONTROLSHARED_EXPORT CloseCard_leaser(int mnums,int ionums)
{
    if (0 != mnums)
    {
        if (g_bIniMotorOK)
